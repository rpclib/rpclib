...
public:
   ...
   * @code clmdep_asio::cancellation_type_t filter(
   *     clmdep_asio::cancellation_type_t); @endcode
   *
   * The library provides the following pre-defined cancellation filters:
   *
   * @li clmdep_asio::disable_cancellation
   * @li clmdep_asio::enable_terminal_cancellation
   * @li clmdep_asio::enable_partial_cancellation
   * @li clmdep_asio::enable_total_cancellation
   */
   ...
   * cancellation signals as they are received from the parent slot. This
   * function object must have the signature:
   * @code clmdep_asio::cancellation_type_t in_filter(
   *     clmdep_asio::cancellation_type_t); @endcode
   *
   ...
   * @code clmdep_asio::cancellation_type_t out_filter(
   *     clmdep_asio::cancellation_type_t); @endcode
   *
   * The library provides the following pre-defined cancellation filters:
   *
