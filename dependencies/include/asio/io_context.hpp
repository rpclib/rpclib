...
private:
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * clmdep_asio::io_context& ctx = clmdep_asio::query(
...
struct equality_comparable<
    clmdep_asio::io_context::basic_executor_type<Allocator, Bits>
  >
{
  ...
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
  typedef clmdep_asio::io_context::basic_executor_type<
...
struct require_member<
  ...
  > : clmdep_asio::detail::io_context_bits
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
  typedef clmdep_asio::io_context::basic_executor_type<
  ...
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef clmdep_asio::io_context& result_type;
};
