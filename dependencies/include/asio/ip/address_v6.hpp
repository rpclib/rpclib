...
template <>
struct hash<clmdep_asio::ip::address_v6>
{
  std::size_t operator()(const clmdep_asio::ip::address_v6& addr)
    const noexcept
  {
    const clmdep_asio::ip::address_v6::bytes_type bytes = addr.to_bytes();
