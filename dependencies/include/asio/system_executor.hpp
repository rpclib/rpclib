...
private:
   ...
   *
   * For example:
   * @code clmdep_asio::system_executor ex1;
...
private:
   ...
   *
   * For example:
   * @code clmdep_asio::system_executor ex;
   ...
   * For example:
   * @code clmdep_asio::system_executor ex;
   * clmdep_asio::system_context& pool = clmdep_asio::query(
...
struct equality_comparable<
    clmdep_asio::basic_system_executor<Blocking, Relationship, Allocator>
  >
{
  ...
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
  typedef clmdep_asio::basic_system_executor<
      clmdep_asio::execution::blocking_t::possibly_t,
  ...
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
  typedef clmdep_asio::basic_system_executor<Blocking,
      clmdep_asio::execution::relationship_t::fork_t,
  ...
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef clmdep_asio::system_context& result_type;
};
...
struct query_member<
    clmdep_asio::basic_system_executor<Blocking, Relationship, Allocator>,
    clmdep_asio::execution::allocator_t<Allocator>
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
