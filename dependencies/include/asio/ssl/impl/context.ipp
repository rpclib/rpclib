  ...
  : handle_(0)
{
  ...
  if (handle_ == 0)
  {
    clmdep_asio::error_code ec = translate_error(::ERR_get_error());
...
clmdep_asio::error_code context::translate_error(long error)
{
#if (OPENSSL_VERSION_NUMBER >= 0x30000000L)
  ...
  return clmdep_asio::error_code(static_cast<int>(error),
