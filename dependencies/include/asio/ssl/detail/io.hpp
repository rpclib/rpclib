...
class io_op
  : public clmdep_asio::detail::base_from_cancellation_state<Handler>
{
public:
  io_op(Stream& next_layer, stream_core& core,
      const Operation& op, Handler& handler)
    : clmdep_asio::detail::base_from_cancellation_state<Handler>(handler),
  ...
  io_op(const io_op& other)
    : clmdep_asio::detail::base_from_cancellation_state<Handler>(other),
  ...
  io_op(io_op&& other)
    : clmdep_asio::detail::base_from_cancellation_state<Handler>(
        static_cast<
          clmdep_asio::detail::base_from_cancellation_state<Handler>&&>(other)),
      next_layer_(other.next_layer_),
      core_(other.core_),
