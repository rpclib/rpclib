...
public:
   ...
   * @code void(clmdep_asio::error_code, int) @endcode
   *
  ...
  auto async_wait(
    ...
    -> decltype(
      async_initiate<SignalToken, void (clmdep_asio::error_code, int)>(
        declval<initiate_async_wait>(), token))
  {
    return async_initiate<SignalToken, void (clmdep_asio::error_code, int)>(
