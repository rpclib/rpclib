...
#define ASIO_COMPLETION_HANDLER_FOR(sig) \
  ::clmdep_asio::completion_handler_for<sig>
#define ASIO_COMPLETION_HANDLER_FOR2(sig0, sig1) \
  ::clmdep_asio::completion_handler_for<sig0, sig1>
#define ASIO_COMPLETION_HANDLER_FOR3(sig0, sig1, sig2) \
  ::clmdep_asio::completion_handler_for<sig0, sig1, sig2>
...
# define ASIO_INITFN_RESULT_TYPE2(ct, sig0, sig1) \
  typename ::clmdep_asio::async_result< \
    typename ::clmdep_asio::decay<ct>::type, sig0, sig1>::return_type
# define ASIO_INITFN_RESULT_TYPE3(ct, sig0, sig1, sig2) \
  typename ::clmdep_asio::async_result< \
    typename ::clmdep_asio::decay<ct>::type, sig0, sig1, sig2>::return_type
...
#define ASIO_HANDLER_TYPE2(ct, sig0, sig1) \
  typename ::clmdep_asio::async_result< \
    typename ::clmdep_asio::decay<ct>::type, \
...
#define ASIO_COMPLETION_TOKEN_FOR(sig) \
  ::clmdep_asio::completion_token_for<sig>
#define ASIO_COMPLETION_TOKEN_FOR2(sig0, sig1) \
  ::clmdep_asio::completion_token_for<sig0, sig1>
#define ASIO_COMPLETION_TOKEN_FOR3(sig0, sig1, sig2) \
  ::clmdep_asio::completion_token_for<sig0, sig1, sig2>
...
#define ASIO_ASYNC_OPERATION(t) \
  ::clmdep_asio::async_operation<t>
#define ASIO_ASYNC_OPERATION1(t, a0) \
  ::clmdep_asio::async_operation<t, a0>
#define ASIO_ASYNC_OPERATION2(t, a0, a1) \
  ::clmdep_asio::async_operation<t, a0, a1>
#define ASIO_ASYNC_OPERATION3(t, a0, a1, a2) \
  ::clmdep_asio::async_operation<t, a0, a1, a2>
