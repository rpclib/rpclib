 ...
 * expression <tt>clmdep_asio::require(E, P0, Pn...)</tt> for some
 ...
 *   <tt>clmdep_asio::require(E, P0, Pn...)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise,
 *   <tt>clmdep_asio::require(clmdep_asio::require(E, P0), Pn...)</tt>
 *   if <tt>N > 0</tt> and the expression
 *   <tt>clmdep_asio::require(clmdep_asio::require(E, P0), Pn...)</tt>
 *   is a valid expression.
 *
 * @li Otherwise, <tt>clmdep_asio::require(E, P0, Pn...)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>clmdep_asio::require(std::declval<T>(),
 ...
 * type of the expression <tt>clmdep_asio::require(std::declval<T>(),
