...
public:
  ...
  {
    return clmdep_asio::query(system_executor(), execution::context);
  }
  ...
  {
    clmdep_asio::require(system_executor(), Blocking()).execute(
...
struct equality_comparable<
    clmdep_asio::detail::promise_executor<T, Blocking>>
{
...
struct execute_member<
    clmdep_asio::detail::promise_executor<T, Blocking>, Function>
{
  static constexpr bool is_valid = true;
  ...
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef clmdep_asio::detail::promise_executor<T,
