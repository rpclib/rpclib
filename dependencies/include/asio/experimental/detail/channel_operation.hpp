...
protected:
  ...
  friend class clmdep_asio::detail::op_queue_access;
...
public:
  ...
  {
    (clmdep_asio::detail::initiate_post_with_executor<IoExecutor>(io_exec))(
...
public:
  ...
  void post(const IoExecutor&, Function& function, Handler& handler)
  {
    ...
    clmdep_asio::prefer(
        clmdep_asio::require(executor_, execution::blocking.never),
        execution::allocator(allocator)
      ).execute(static_cast<Function&&>(function));
  }
...
public:
  ...
  void immediate(Function& function, Handler& handler, ...)
  {
    ...
    (clmdep_asio::detail::initiate_dispatch_with_executor<immediate_ex_type>(
  ...
  void immediate(Function& function, Handler&,
      ...
      >*)
  {
    (clmdep_asio::detail::initiate_post_with_executor<
        typename base1_type::executor_type>(
