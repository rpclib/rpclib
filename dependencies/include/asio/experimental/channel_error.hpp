...
extern ASIO_DECL
const clmdep_asio::error_category& get_channel_category();

static const clmdep_asio::error_category&
  channel_category ASIO_UNUSED_VARIABLE
  = clmdep_asio::experimental::error::get_channel_category();
...
template<> struct is_error_code_enum<
    clmdep_asio::experimental::error::channel_errors>
{
...
inline clmdep_asio::error_code make_error_code(channel_errors e)
{
