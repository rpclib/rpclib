 ...
 * {
 *   return clmdep_asio::async_initiate<
 *     CompletionToken, void(std::error_code)>(
 *       clmdep_asio::experimental::co_composed(
 *         [](auto state, tcp::socket& socket) -> void
 *         {
 *           state.reset_cancellation_state(
 *             clmdep_asio::enable_terminal_cancellation());
 *
 ...
 *                 clmdep_asio::as_tuple(clmdep_asio::deferred));
 *
 *             if (e1)
 ...
 *                 make_error_code(clmdep_asio::error::operation_aborted));
 *
 *             auto [e2, n2] =
 *               co_await clmdep_asio::async_write(socket,
 *                 clmdep_asio::buffer(data, n1),
 *                 clmdep_asio::as_tuple(clmdep_asio::deferred));
 *
 *             if (e2)
 ...
 *                     clmdep_asio::buffer(data), clmdep_asio::deferred);
 *
 *                 co_await clmdep_asio::async_write(socket,
 *                     clmdep_asio::buffer(data, n), clmdep_asio::deferred);
 *               }
 *             }
