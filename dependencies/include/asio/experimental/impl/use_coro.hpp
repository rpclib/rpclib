...
struct async_result<experimental::use_coro_t<Allocator>, R()>
{
  ...
  static auto initiate_impl(Initiation initiation,
    ...
    -> experimental::coro<void() noexcept, void,
      clmdep_asio::associated_executor_t<Initiation>, Allocator>
  {
  ...
  static auto initiate_impl(clmdep_asio::detail::initiation_archetype<R()>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void(), void,
      clmdep_asio::any_io_executor, Allocator>;
...
template <typename Allocator, typename R>
struct async_result<
    experimental::use_coro_t<Allocator>, R(clmdep_asio::error_code)>
{
  template <typename Initiation, typename... InitArgs>
  static auto initiate_impl(Initiation initiation,
      std::allocator_arg_t, Allocator, InitArgs... args)
      ...
      clmdep_asio::associated_executor_t<Initiation>, Allocator>
  {
    co_await deferred_async_operation<
      R(clmdep_asio::error_code), Initiation, InitArgs...>(
        deferred_init_tag{}, std::move(initiation), std::move(args)...);
  }

  template <typename... InitArgs>
  static auto initiate_impl(
      clmdep_asio::detail::initiation_archetype<R(clmdep_asio::error_code)>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void(), void,
      clmdep_asio::any_io_executor, Allocator>;
    ...
    experimental::use_coro_t<Allocator>, R(std::exception_ptr)>
{
  ...
  template <typename... InitArgs>
  static auto initiate_impl(
      clmdep_asio::detail::initiation_archetype<R(std::exception_ptr)>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void(), void,
      clmdep_asio::any_io_executor, Allocator>;
...
struct async_result<experimental::use_coro_t<Allocator>, R(T)>
{
  ...
  template <typename... InitArgs>
  static auto initiate_impl(clmdep_asio::detail::initiation_archetype<R(T)>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void() noexcept, T,
      clmdep_asio::any_io_executor, Allocator>;
...
template <typename Allocator, typename R, typename T>
struct async_result<
    experimental::use_coro_t<Allocator>, R(clmdep_asio::error_code, T)>
{
  template <typename Initiation, typename... InitArgs>
  static auto initiate_impl(Initiation initiation,
      std::allocator_arg_t, Allocator, InitArgs... args)
      ...
      clmdep_asio::associated_executor_t<Initiation>, Allocator>
  {
    co_return co_await deferred_async_operation<
      R(clmdep_asio::error_code, T), Initiation, InitArgs...>(
        deferred_init_tag{}, std::move(initiation), std::move(args)...);
  }

  template <typename... InitArgs>
  static auto initiate_impl(
      clmdep_asio::detail::initiation_archetype<
        R(clmdep_asio::error_code, T)>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void(), T, clmdep_asio::any_io_executor, Allocator>;
    ...
    experimental::use_coro_t<Allocator>, R(std::exception_ptr, T)>
{
  ...
  template <typename... InitArgs>
  static auto initiate_impl(
      clmdep_asio::detail::initiation_archetype<R(std::exception_ptr, T)>,
      std::allocator_arg_t, Allocator, InitArgs... args)
    -> experimental::coro<void(), T, clmdep_asio::any_io_executor, Allocator>;
