...
private:
  ...
  typedef detail::channel_service<clmdep_asio::detail::null_mutex> service_type;
...
public:
  ...
  basic_channel(const executor_type& ex, std::size_t max_buffer_size = 0)
    : service_(&clmdep_asio::use_service<service_type>(
  ...
  basic_channel(ExecutionContext& context, std::size_t max_buffer_size = 0,
      ...
      > = defaulted_constraint())
    : service_(&clmdep_asio::use_service<service_type>(context)),
      impl_(),
   ...
   * @c clmdep_asio::experimental::error::channel_cancelled. Outstanding receive
   ...
   * @code void(clmdep_asio::error_code) @endcode
   */
  template <typename... Args,
...
private:
  ...
  {
    return clmdep_asio::query(t, execution::context);
  }
  ...
  public:
    ...
    {
      clmdep_asio::detail::non_const_lvalue<SendHandler> handler2(handler);
  ...
  public:
    ...
    {
      clmdep_asio::detail::non_const_lvalue<ReceiveHandler> handler2(handler);
