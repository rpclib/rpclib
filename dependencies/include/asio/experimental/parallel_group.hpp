...
{
  typedef clmdep_asio::detail::array<std::size_t, N> order_type;
...
/**
 * See the documentation for clmdep_asio::experimental::make_parallel_group for
 * a usage example.
 */
  ...
  struct initiate_async_wait
  {
    ...
    void operator()(Handler&& h, Condition&& c, std::tuple<Ops...>&& ops) const
    {
      detail::parallel_group_launch(
          ...
          ops, clmdep_asio::detail::index_sequence_for<Ops...>());
    }
  };
...
public:
   ...
   * operations, it must return a clmdep_asio::cancellation_type value other
   * than <tt>clmdep_asio::cancellation_type::none</tt>.
   *
   ...
   *
   * @li clmdep_asio::experimental::wait_for_all
   * @li clmdep_asio::experimental::wait_for_one
   * @li clmdep_asio::experimental::wait_for_one_error
   * @li clmdep_asio::experimental::wait_for_one_success
   */
  ...
  auto async_wait(CancellationCondition cancellation_condition,
    ...
    -> decltype(
      clmdep_asio::async_initiate<CompletionToken, signature>(
        declval<initiate_async_wait>(), token,
        std::move(cancellation_condition), std::move(ops_)))
  {
    return clmdep_asio::async_initiate<CompletionToken, signature>(
...
/**
 * For example:
 * @code clmdep_asio::experimental::make_parallel_group(
 *    [&](auto token)
 *    {
 *      return in.async_read_some(clmdep_asio::buffer(data), token);
 *    },
 *    [&](auto token)
 *    {
 ...
 *    }
 *  ).async_wait(
 *    clmdep_asio::experimental::wait_for_all(),
 *    [](
 ...
 *       clmdep_asio::buffer(data1),
 *       clmdep_asio::deferred
 *     )
 *   );
 *
 ...
 *       clmdep_asio::buffer(data2),
 *       clmdep_asio::deferred
 *     )
 *   );
 *
 * clmdep_asio::experimental::make_parallel_group(ops).async_wait(
 *     clmdep_asio::experimental::wait_for_all(),
 *     [](
 ...
 *   );
 *
 * clmdep_asio::experimental::make_parallel_group(
 *     std::allocator_arg_t,
 *     my_allocator,
 *     ops
 *   ).async_wait(
