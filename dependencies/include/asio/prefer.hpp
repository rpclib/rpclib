 ...
 * expression <tt>clmdep_asio::prefer(E, P0, Pn...)</tt> for some subexpressions
 ...
 *   <tt>clmdep_asio::prefer(E, P0, Pn...)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise,
 *   <tt>clmdep_asio::prefer(clmdep_asio::prefer(E, P0), Pn...)</tt>
 *   if <tt>N > 0</tt> and the expression
 *   <tt>clmdep_asio::prefer(clmdep_asio::prefer(E, P0), Pn...)</tt>
 *   is a valid expression.
 *
 * @li Otherwise, <tt>clmdep_asio::prefer(E, P0, Pn...)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>clmdep_asio::prefer(std::declval<T>(),
 ...
 * type of the expression <tt>clmdep_asio::prefer(std::declval<T>(),
...
using clmdep_asio::conditional_t;
using clmdep_asio::decay_t;
using clmdep_asio::declval;
using clmdep_asio::enable_if_t;
using clmdep_asio::is_applicable_property;
using clmdep_asio::traits::prefer_free;
using clmdep_asio::traits::prefer_member;
using clmdep_asio::traits::require_free;
using clmdep_asio::traits::require_member;
using clmdep_asio::traits::static_require;
