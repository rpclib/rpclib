...
/**
 * @par Example
 * @code clmdep_asio::awaitable<void> my_coroutine()
 * {
 *   clmdep_asio::cancellation_state cs
 *     = co_await clmdep_asio::this_coro::cancellation_state;
 *
 *   // ...
 *
 *   if (cs.cancelled() != clmdep_asio::cancellation_type::none)
 *     // ...
 * } @endcode
 */
 ...
 * clmdep_asio::cancellation_state object <tt>S</tt>, constructed as
 * <tt>S(P)</tt>, into the current coroutine's cancellation state object.
 *
 * @par Example
 * @code clmdep_asio::awaitable<void> my_coroutine()
 * {
 *   co_await clmdep_asio::this_coro::reset_cancellation_state();
 *
 *   // ...
 * } @endcode
 *
 * @note The cancellation state is shared by all coroutines in the same "thread
 * of execution" that was created using clmdep_asio::co_spawn.
 */
 ...
 * Let <tt>P</tt> be the cancellation slot associated with the current
 * coroutine's @ref co_spawn completion handler. Assigns a new
 * clmdep_asio::cancellation_state object <tt>S</tt>, constructed as <tt>S(P,
 ...
 * {
 *   co_await clmdep_asio::this_coro::reset_cancellation_state(
 *       clmdep_asio::enable_partial_cancellation());
 *
 *   // ...
 * } @endcode
 *
 ...
 *   co_await clmdep_asio::this_coro::reset_cancellation_state(
 *       clmdep_asio::enable_partial_cancellation(),
 *       clmdep_asio::disable_cancellation());
 *
 *   // ...
 * } @endcode
 *
 ...
 * @code clmdep_asio::awaitable<void> my_coroutine()
 * {
 *   if (co_await clmdep_asio::this_coro::throw_if_cancelled)
 *     // ...
 *
 *   // ...
 * } @endcode
 ...
 * @code clmdep_asio::awaitable<void> my_coroutine()
 * {
 *   co_await clmdep_asio::this_coro::throw_if_cancelled(false);
 *
 *   // ...
 * } @endcode
 */
