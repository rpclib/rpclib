 ...
 * expression <tt>clmdep_asio::require_concept(E, P)</tt> for some
 ...
 *   with value <tt>true</tt>, <tt>clmdep_asio::require_concept(E, P)</tt> is
 *   ill-formed.
 *
 ...
 *
 * @li Otherwise, <tt>clmdep_asio::require_concept(E, P)</tt> is ill-formed.
 */
 ...
 * <tt>clmdep_asio::require_concept(std::declval<T>(),
...
using clmdep_asio::traits::require_concept_free;
using clmdep_asio::traits::require_concept_member;
using clmdep_asio::traits::static_require_concept;
