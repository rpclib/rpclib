 ...
 * operation, typically using the special value @c clmdep_asio::deferred. For
 * example:
 *
 * @code auto my_deferred_op
 *   = my_socket.async_read_some(my_buffer,
 *       clmdep_asio::deferred); @endcode
 *
...
/**
 * See the documentation for clmdep_asio::deferred_t for a usage example.
 */
