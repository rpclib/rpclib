 ...
 * execution.
 *
 * @param a The clmdep_asio::awaitable object that is the result of calling the
 ...
 * @par Example
 * @code
 * clmdep_asio::awaitable<std::size_t> echo(tcp::socket socket)
 * {
 ...
 *           clmdep_asio::buffer(data), clmdep_asio::use_awaitable);
 *
 *       co_await clmdep_asio::async_write(socket,
 *           clmdep_asio::buffer(data, n), clmdep_asio::use_awaitable);
 *
 *       bytes_transferred += n;
 *     }
 *   }
 ...
 * // ...
 *
 * clmdep_asio::co_spawn(my_executor,
 ...
 * cancellation state, call clmdep_asio::this_coro::reset_cancellation_state.
 */
 ...
 * @par Example
 * @code
 * clmdep_asio::awaitable<void> echo(tcp::socket socket)
 * {
 *   try
 *   {
 *     char data[1024];
 ...
 * // ...
 *
 * clmdep_asio::co_spawn(my_io_context,
 *   echo(std::move(my_tcp_socket)),
 *   [](std::exception_ptr e, std::size_t n)
 *   {
 *     std::cout << "transferred " << n << "\n";
 ...
 * @c clmdep_asio::awaitable<R,E> that will be used as the coroutine's entry
 * point.
 *
 ...
 * @code clmdep_asio::awaitable<R, AwaitableExecutor> F() @endcode
 *
 * @par Example
 * @code
 * clmdep_asio::awaitable<std::size_t> echo(tcp::socket socket)
