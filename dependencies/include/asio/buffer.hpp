 ...
 * <tt>clmdep_asio::buffer_literals</tt>, may be used to create @c const_buffer
 * objects from string, binary integer, and hexadecimal integer literals.
 * For example:
 *
 * @code
 * using namespace clmdep_asio::buffer_literals;
 *
 * clmdep_asio::const_buffer b1 = "hello"_buf;
 * clmdep_asio::const_buffer b2 = 0xdeadbeef_buf;
 * clmdep_asio::const_buffer b3 = 0x0123456789abcdef0123456789abcdef_buf;
 * clmdep_asio::const_buffer b4 = 0b1010101011001100_buf; @endcode
 *
