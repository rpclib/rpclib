...
public:
  ...
  auto async_connect(const endpoint_type& peer_endpoint,
    ...
    -> decltype(
      async_initiate<ConnectToken, void (clmdep_asio::error_code)>(
        declval<initiate_async_connect>(), token,
        peer_endpoint, declval<clmdep_asio::error_code&>()))
  {
    ...
    return async_initiate<ConnectToken, void (clmdep_asio::error_code)>(
  ...
  auto async_wait(wait_type w,
    ...
    -> decltype(
      async_initiate<WaitToken, void (clmdep_asio::error_code)>(
          declval<initiate_async_wait>(), token, w))
  {
    return async_initiate<WaitToken, void (clmdep_asio::error_code)>(
