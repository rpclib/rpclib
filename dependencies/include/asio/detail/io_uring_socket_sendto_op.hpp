...
{
public:
  io_uring_socket_sendto_op_base(const clmdep_asio::error_code& success_ec,
  ...
  static bool do_perform(io_uring_operation* base, bool after_completion)
  {
    ...
    if (o->ec_ && o->ec_ == clmdep_asio::error::would_block)
    {
...
private:
  ...
  buffer_sequence_adapter<clmdep_asio::const_buffer, ConstBufferSequence> bufs_;
  msghdr msghdr_;
};
...
public:
  ...
  io_uring_socket_sendto_op(const clmdep_asio::error_code& success_ec,
