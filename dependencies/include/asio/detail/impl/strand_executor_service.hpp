    ...
    >*)
{
  return strand_executor_service::do_execute(impl, ex,
      ...
      clmdep_asio::query(ex, execution::allocator));
}
    ...
    Executor& ex, Function&& function, const Allocator& a)
{
  ...
  if (clmdep_asio::query(ex, execution::blocking) != execution::blocking.never
