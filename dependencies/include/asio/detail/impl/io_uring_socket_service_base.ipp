...
io_uring_socket_service_base::io_uring_socket_service_base(
  ...
  : io_uring_service_(clmdep_asio::use_service<io_uring_service>(context))
{
...
clmdep_asio::error_code io_uring_socket_service_base::close(
    io_uring_socket_service_base::base_implementation_type& impl,
...
clmdep_asio::error_code io_uring_socket_service_base::cancel(
    io_uring_socket_service_base::base_implementation_type& impl,
    clmdep_asio::error_code& ec)
{
  if (!is_open(impl))
...
clmdep_asio::error_code io_uring_socket_service_base::do_open(
    io_uring_socket_service_base::base_implementation_type& impl,
...
clmdep_asio::error_code io_uring_socket_service_base::do_assign(
