...
clmdep_asio::error_code io_uring_file_service::open(
...
clmdep_asio::error_code io_uring_file_service::resize(
    io_uring_file_service::implementation_type& impl,
...
clmdep_asio::error_code io_uring_file_service::sync_all(
    io_uring_file_service::implementation_type& impl,
    clmdep_asio::error_code& ec)
{
...
clmdep_asio::error_code io_uring_file_service::sync_data(
    io_uring_file_service::implementation_type& impl,
    clmdep_asio::error_code& ec)
{
