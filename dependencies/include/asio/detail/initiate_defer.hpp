...
public:
      ...
      >* = 0) const
  {
    ...
    clmdep_asio::prefer(
        clmdep_asio::require(ex, execution::blocking.never),
      ...
      >* = 0) const
  {
    ...
    ex.defer(clmdep_asio::detail::bind_handler(
...
public:
      ...
      >* = 0) const
  {
    ...
    clmdep_asio::prefer(
        clmdep_asio::require(ex_, execution::blocking.never),
        execution::relationship.continuation,
        execution::allocator(alloc)
      ).execute(
        clmdep_asio::detail::bind_handler(
      ...
      >* = 0) const
  {
    ...
    ex_.defer(clmdep_asio::detail::bind_handler(
          static_cast<CompletionHandler&&>(handler)), alloc);
  }
