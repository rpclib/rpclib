...
public:
  ...
  static Buffer linearise(const Buffers& buffer_sequence,
      const clmdep_asio::mutable_buffer& storage)
  {
    return buffer_sequence_adapter::linearise(
        clmdep_asio::buffer_sequence_begin(buffer_sequence),
        clmdep_asio::buffer_sequence_end(buffer_sequence), storage);
  }
...
private:
  ...
  static Buffer linearise(Iterator begin, Iterator end,
      const clmdep_asio::mutable_buffer& storage)
  {
    clmdep_asio::mutable_buffer unused_storage = storage;
    Iterator iter = begin;
    while (iter != end && unused_storage.size() != 0)
    {
      ...
      unused_storage += clmdep_asio::buffer_copy(unused_storage, buffer);
    }
...
public:
  ...
  static Buffer linearise(const clmdep_asio::mutable_buffer& buffer_sequence,
      const Buffer&)
  {
    return Buffer(buffer_sequence);
  }
...
public:
  ...
  static Buffer linearise(const clmdep_asio::const_buffer& buffer_sequence,
      const Buffer&)
  {
    return Buffer(buffer_sequence);
  }
...
public:
  ...
  static Buffer linearise(const clmdep_asio::mutable_buffers_1& buffer_sequence,
      const Buffer&)
  {
    return Buffer(buffer_sequence);
  }
...
public:
  ...
  static Buffer linearise(const clmdep_asio::const_buffers_1& buffer_sequence,
      const Buffer&)
  {
    return Buffer(buffer_sequence);
  }
...
template <typename Buffer>
class buffer_sequence_adapter<Buffer, clmdep_asio::mutable_registered_buffer>
  : buffer_sequence_adapter_base
{
public:
  enum { is_single_buffer = true };
  ...
  explicit buffer_sequence_adapter(
      const clmdep_asio::mutable_registered_buffer& buffer_sequence)
  {
...
template <typename Buffer>
class buffer_sequence_adapter<Buffer, clmdep_asio::const_registered_buffer>
  : buffer_sequence_adapter_base
{
public:
  enum { is_single_buffer = true };
  ...
  explicit buffer_sequence_adapter(
      const clmdep_asio::const_registered_buffer& buffer_sequence)
  {
    init_native_buffer(buffer_, buffer_sequence.buffer());
    total_buffer_size_ = buffer_sequence.size();
    registered_id_ = buffer_sequence.id();
...
public:
      ...
      const clmdep_asio::mutable_buffer& storage)
  {
    ...
    return Buffer(storage.data(),
        clmdep_asio::buffer_copy(storage, buffer_sequence));
  }
