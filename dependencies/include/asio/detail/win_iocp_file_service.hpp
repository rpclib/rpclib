...
public:
  ...
  ASIO_DECL clmdep_asio::error_code resize(implementation_type& impl,
      uint64_t n, clmdep_asio::error_code& ec);

  // Synchronise the file to disk.
  ASIO_DECL clmdep_asio::error_code sync_all(implementation_type& impl,
      clmdep_asio::error_code& ec);

  // Synchronise the file data to disk.
  ASIO_DECL clmdep_asio::error_code sync_data(implementation_type& impl,
      clmdep_asio::error_code& ec);
      ...
      const ConstBufferSequence& buffers, clmdep_asio::error_code& ec)
  {
    ...
    impl.offset_ += clmdep_asio::buffer_size(buffers);
