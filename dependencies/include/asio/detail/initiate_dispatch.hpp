...
public:
      ...
      >* = 0) const
  {
    ...
    clmdep_asio::prefer(ex, execution::allocator(alloc)).execute(
      ...
      >* = 0) const
  {
    ...
    ex.dispatch(clmdep_asio::detail::bind_handler(
...
public:
      ...
      >* = 0) const
  {
    ...
    clmdep_asio::prefer(ex_, execution::allocator(alloc)).execute(
        clmdep_asio::detail::bind_handler(
          static_cast<CompletionHandler&&>(handler)));
  }
      ...
      >* = 0) const
  {
    ...
    ex_.dispatch(clmdep_asio::detail::bind_handler(
          static_cast<CompletionHandler&&>(handler)), alloc);
  }
