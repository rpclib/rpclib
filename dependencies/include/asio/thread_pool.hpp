 ...
 *
 * To submit functions to the thread pool, use the @ref clmdep_asio::dispatch,
...
private:
   ...
   * clmdep_asio::require customisation point.
   *
   * For example:
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = clmdep_asio::require(ex1,
   *     clmdep_asio::execution::blocking.possibly); @endcode
   */
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = clmdep_asio::require(ex1,
   *     clmdep_asio::execution::blocking.always); @endcode
   */
  constexpr basic_executor_type<Allocator,
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = clmdep_asio::require(ex1,
   *     clmdep_asio::execution::blocking.never); @endcode
   */
  constexpr basic_executor_type<Allocator,
      ASIO_UNSPECIFIED(Bits & ~blocking_mask)>
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = clmdep_asio::require(ex1,
   *     clmdep_asio::execution::relationship.fork); @endcode
   */
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = clmdep_asio::require(ex1,
   *     clmdep_asio::execution::relationship.continuation); @endcode
   */
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = clmdep_asio::require(ex1,
   *     clmdep_asio::execution::outstanding_work.tracked); @endcode
   */
  constexpr basic_executor_type<Allocator,
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = clmdep_asio::require(ex1,
   *     clmdep_asio::execution::outstanding_work.untracked); @endcode
   */
  constexpr basic_executor_type<Allocator,
      ASIO_UNSPECIFIED(Bits & ~outstanding_work_tracked)>
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = clmdep_asio::require(ex1,
   *     clmdep_asio::execution::allocator(my_allocator)); @endcode
   */
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = clmdep_asio::require(ex1,
   *     clmdep_asio::execution::allocator); @endcode
   */
...
private:
  ...
  friend struct clmdep_asio::execution::detail::mapping_t<0>;
  friend struct clmdep_asio::execution::detail::outstanding_work_t<0>;
#endif // !defined(GENERATING_DOCUMENTATION)

  /// Query the current value of the @c mapping property.
  /**
   * Do not call this function directly. It is intended for use with the
   * clmdep_asio::query customisation point.
   *
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * if (clmdep_asio::query(ex, clmdep_asio::execution::mapping)
   *       == clmdep_asio::execution::mapping.thread)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * clmdep_asio::thread_pool& pool = clmdep_asio::query(
   *     ex, clmdep_asio::execution::context); @endcode
   */
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * if (clmdep_asio::query(ex, clmdep_asio::execution::blocking)
   *       == clmdep_asio::execution::blocking.always)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * if (clmdep_asio::query(ex, clmdep_asio::execution::relationship)
   *       == clmdep_asio::execution::relationship.continuation)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * if (clmdep_asio::query(ex, clmdep_asio::execution::outstanding_work)
   *       == clmdep_asio::execution::outstanding_work.tracked)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * auto alloc = clmdep_asio::query(ex,
   *     clmdep_asio::execution::allocator); @endcode
   */
  template <typename OtherAllocator>
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * std::size_t occupancy = clmdep_asio::query(
   *     ex, clmdep_asio::execution::occupancy); @endcode
   */
...
struct equality_comparable<
    clmdep_asio::thread_pool::basic_executor_type<Allocator, Bits>
  >
{
...
struct require_member<
    clmdep_asio::thread_pool::basic_executor_type<Allocator, Bits>,
    clmdep_asio::execution::blocking_t::possibly_t
  > : clmdep_asio::detail::thread_pool_bits
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef clmdep_asio::thread_pool::basic_executor_type<
...
struct require_member<
    clmdep_asio::thread_pool::basic_executor_type<Allocator, Bits>,
    clmdep_asio::execution::blocking_t::always_t
  > : clmdep_asio::detail::thread_pool_bits
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
  typedef clmdep_asio::thread_pool::basic_executor_type<Allocator,
...
struct require_member<
    clmdep_asio::thread_pool::basic_executor_type<Allocator, Bits>,
    clmdep_asio::execution::blocking_t::never_t
  > : clmdep_asio::detail::thread_pool_bits
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
...
struct require_member<
    clmdep_asio::thread_pool::basic_executor_type<Allocator, Bits>,
    clmdep_asio::execution::relationship_t::fork_t
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
...
struct require_member<
    clmdep_asio::thread_pool::basic_executor_type<Allocator, Bits>,
    clmdep_asio::execution::relationship_t::continuation_t
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
...
struct require_member<
    clmdep_asio::thread_pool::basic_executor_type<Allocator, Bits>,
    clmdep_asio::execution::outstanding_work_t::tracked_t
  > : clmdep_asio::detail::thread_pool_bits
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
...
struct require_member<
    clmdep_asio::thread_pool::basic_executor_type<Allocator, Bits>,
    clmdep_asio::execution::outstanding_work_t::untracked_t
  > : clmdep_asio::detail::thread_pool_bits
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
...
struct require_member<
    clmdep_asio::thread_pool::basic_executor_type<Allocator, Bits>,
    clmdep_asio::execution::allocator_t<void>
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
...
struct require_member<
    clmdep_asio::thread_pool::basic_executor_type<Allocator, Bits>,
    clmdep_asio::execution::allocator_t<OtherAllocator>
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = false;
...
struct query_static_constexpr_member<
    clmdep_asio::thread_pool::basic_executor_type<Allocator, Bits>,
    Property,
    typename clmdep_asio::enable_if<
      clmdep_asio::is_convertible<
        Property,
        clmdep_asio::execution::outstanding_work_t
      >::value
    >::type
  > : clmdep_asio::detail::thread_pool_bits
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef clmdep_asio::execution::outstanding_work_t result_type;
...
struct query_static_constexpr_member<
    ...
    typename clmdep_asio::enable_if<
      clmdep_asio::is_convertible<
        Property,
        clmdep_asio::execution::mapping_t
      >::value
    >::type
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef clmdep_asio::execution::mapping_t::thread_t result_type;
...
struct query_member<
    ...
    typename clmdep_asio::enable_if<
      clmdep_asio::is_convertible<
        Property,
        clmdep_asio::execution::blocking_t
      >::value
    >::type
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef clmdep_asio::execution::blocking_t result_type;
};
...
struct query_member<
    ...
    typename clmdep_asio::enable_if<
      clmdep_asio::is_convertible<
        Property,
        clmdep_asio::execution::relationship_t
      >::value
    >::type
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef clmdep_asio::execution::relationship_t result_type;
};

template <typename Allocator, unsigned int Bits>
struct query_member<
    clmdep_asio::thread_pool::basic_executor_type<Allocator, Bits>,
    clmdep_asio::execution::occupancy_t
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
...
struct query_member<
    clmdep_asio::thread_pool::basic_executor_type<Allocator, Bits>,
    clmdep_asio::execution::context_t
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef clmdep_asio::thread_pool& result_type;
};
