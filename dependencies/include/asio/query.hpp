 ...
 * expression <tt>clmdep_asio::query(E, P)</tt> for some
 ...
 *   constant expression with value <tt>true</tt>, <tt>clmdep_asio::query(E,
 *   P)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise, <tt>clmdep_asio::query(E, P)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>clmdep_asio::query(std::declval<T>(),
 ...
 * type of the expression <tt>clmdep_asio::query(std::declval<T>(),
...
using clmdep_asio::traits::query_free;
using clmdep_asio::traits::query_member;
using clmdep_asio::traits::static_query;
