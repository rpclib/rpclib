...
struct as<std::chrono::system_clock::time_point> {
    typename std::chrono::system_clock::time_point operator()(clmdep_msgpack::object const& o) const {
...
struct convert<std::chrono::system_clock::time_point> {
    clmdep_msgpack::object const& operator()(clmdep_msgpack::object const& o, std::chrono::system_clock::time_point& v) const {
        if(o.type != clmdep_msgpack::type::EXT) { throw clmdep_msgpack::type_error(); }
        if(o.via.ext.type() != -1) { throw clmdep_msgpack::type_error(); }
        std::chrono::system_clock::time_point tp;
        switch(o.via.ext.size) {
...
struct pack<std::chrono::system_clock::time_point> {
    ...
    clmdep_msgpack::packer<Stream>& operator()(clmdep_msgpack::packer<Stream>& o, const std::chrono::system_clock::time_point& v) const {
...
struct object_with_zone<std::chrono::system_clock::time_point> {
    void operator()(clmdep_msgpack::object::with_zone& o, const std::chrono::system_clock::time_point& v) const {
        int64_t count = static_cast<int64_t>(v.time_since_epoch().count());
