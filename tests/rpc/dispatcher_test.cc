...
TEST_F(binding_test, freefunc_void_zeroarg) {
  const unsigned char raw_msg[] =
      "\x94\x00\x00\xb2\x64\x75\x6d\x6d\x79\x5f"
...
TEST_F(binding_test, freefunc_void_singlearg) {
  const unsigned char raw_msg[] =
      "\x94\x00\x00\xb4\x64\x75\x6d\x6d\x79\x5f"
...
TEST_F(binding_test, freefunc_void_multiarg) {
  const unsigned char raw_msg[] =
      "\x94\x00\x00\xb3\x64\x75\x6d\x6d\x79\x5f"
...
TEST_F(binding_test, stdfunc_void_zeroarg) {
  ...
  const unsigned char raw_msg[] =
      ...
      "\x76\x6f\x69\x64\x5f\x7a\x65\x72\x6f\x61"
      "\x72\x67\x90";
  dispatcher.bind("dummy_void_zeroarg", std::function<void()>(std::bind(
                                            &IDummy::dummy_void_zeroarg, &md)));
  raw_call(raw_msg);
}
